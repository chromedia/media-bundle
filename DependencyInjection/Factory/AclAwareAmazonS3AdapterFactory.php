...
class AclAwareAmazonS3AdapterFactory implements AdapterFactoryInterface
{
    ...
    */
    ...
    {
        $container
            ->setDefinition($id.'.delegate', new DefinitionDecorator('chromedia_gaufrette.adapter.amazon_s3'))
        ...
        $def = $container
            ->setDefinition($id, new DefinitionDecorator('chromedia_gaufrette.adapter.acl_aware_amazon_s3'))
